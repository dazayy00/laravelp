...
public function getImagen($id)
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mascotas.inicio')->with('success', 'Mascota agregada con éxito.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('mascotas.inicio')->with('success', 'Mascota actualizada con éxito.');
    }
    ...
    public function destroy($id)
    {
        $mascota = Mascota::findOrFail($id);
        $mascota->delete();
        return redirect()->route('mascotas.inicio')->with('success', 'Mascota eliminada con éxito.');
    }
