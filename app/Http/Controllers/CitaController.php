    ...
    public function inicio()
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('citas.inicio')->with('success', 'Cita agendada con éxito.');
    }
    ...
    public function edit($id)
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('citas.inicio')->with('success', 'Cita actualizada con éxito.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('citas.inicio')->with('success', 'Cita eliminada con éxito.');
    }
